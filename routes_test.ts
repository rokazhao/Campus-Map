...
describe('routes', function() {
  ...
  it('data_schedule', function() {
    ...
    assert.deepStrictEqual(res2._getData(), {friends: [], schedule: []});
  ...
  it('getShortestPath', function() {
    ...
    const req4 = httpMocks.createRequest(
        {method: 'POST', url: '/api/setData',
         body: {user: "Kevin", friends:[], schedule: [
            {hour: "9:30", location: "MLR", desc: "GREEK 101"},
            {hour: "10:30", location: "CS2", desc: "CSE 989"},
            {hour: "11:30", location: "HUB", desc: "nom nom"},
          ]}});
    ...
    // Statement Coverage: covers case with schedule and friends
    // Branch Coverage: covers branch with user, schedule, friends
    const req8 = httpMocks.createRequest(
      {method: 'POST', url: '/api/setData',
       body: {user: "Alice", 
              friends: ["Kevin"],
              schedule: [
          {hour: "9:30", location: "KNE", desc: "MATH 101"},
          {hour: "10:30", location: "GWN", desc: "PHYS 201"},
    ...
    // Statement Coverage: covers case with friends
    // Branch Coverage: covers branch with user and friends
    ...
    // Statement Coverage: covers case with two friends being nearby
    // Branch Coverage: covers mutual friendship case, with nearby users
    ...
    assert.deepStrictEqual(res10._getData().nearby[0].friend, "Alice");
